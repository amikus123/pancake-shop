const cart = (state = [], action) => {
  ...
  switch (action.type) {
    ...
    case "REMOVE ITEM":
      ...
      return state;
    case "REMOVE ALL OF ITEM":
      const itemIndexRemoveALL = checkIfInside(action.payload.obj.name);
      state[itemIndexRemoveALL].amount = 0;
      state.splice(itemIndexRemoveALL, 1);
      return state;
